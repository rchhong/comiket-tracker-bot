...
class Currency:
    ...
    def __init__(self, api_key:str, currency_from:str="JPY", currency_to:str="USD", log_file='currency.log'):
        self.current_rate = 0
        ...
        lfHandler.setFormatter(logging.Formatter('%(asctime)s - %(name)s - %(levelname)s - %(message)s'))
